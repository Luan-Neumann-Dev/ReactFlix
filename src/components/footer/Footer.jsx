      ...
      <Container>
        ...
        <div className="footer-bottom flex items-center justify-between">
          <Paragraph className="copyright-text">
            &copy; {currentYear.getFullYear()} ReactFlix. All Right Reserved.
          </Paragraph>
            ...
            <ul className="item-icons-links flex items-center items-wrap">
             {
                data?.links?.map((link, index) => (
                  <li key={index}>
                    <Link to={link.link_url} className="item-icon-link bg-black10 inline-flex items-center justify-center">
